...
Class Mongo_db
{
     ...
     *
     */
    public function gt($value): array
    {
        $result = [];
     ...
     * @return   $this
     */
    public function where_gt($fields, $value = null): self
    {
        if (isset($fields, $value) && is_string($fields) && $fields != '') {
     ...
     *
     */
    public function gte($value): array
    {
        $result = [];
     ...
     * @return   $this
     */
    public function where_gte($fields, $value = 0): self
    {
        if (isset($fields, $value) && is_string($fields) && $fields != '') {
            $this->push_where_field($fields, $this->gte($value));
        } elseif (isset($fields) && is_array($fields) && !empty($fields)) {
            foreach ($fields as $field => $value) {
                if (is_string($field) && $field != '' && $value) {
                    $this->push_where_field($field, $this->gte($value));
                } else {
                    $this->error('Each field name in list must not be an empty string, value must be numeric', __METHOD__);
                }
            }
     ...
     *
     */
    public function lt($value): array
    {
        $result = [];
     ...
     * @return   $this
     */
    public function where_lt($fields, $value = 0): self
    {
        if (isset($fields, $value) && is_string($fields) && $fields != '') {
            $this->push_where_field($fields, $this->lt($value));
        } elseif (isset($fields) && is_array($fields) && !empty($fields)) {
            foreach ($fields as $field => $value) {
                if (is_string($field) && $field != '' && $value) {
                    $this->push_where_field($field, $this->lt($value));
                } else {
                    $this->error('Each field name in list must not be an empty string, value must be numeric', __METHOD__);
                }
            }
     ...
     *
     */
    public function lte($value): array
    {
        $result = [];
     ...
     * @return   $this
     */
    public function where_lte($fields, $value = 0): self
    {
        if (isset($fields, $value) && is_string($fields) && $fields != '') {
            $this->push_where_field($fields, $this->lte($value));
        } elseif (isset($fields) && is_array($fields) && !empty($fields)) {
            foreach ($fields as $field => $value) {
                if (is_string($field) && $field != '' && $value) {
                    $this->push_where_field($field, $this->lte($value));
                } else {
                    $this->error('Each field name in list must not be an empty string, value must be numeric', __METHOD__);
                }
            }
